...
- **Job**: `bulk_9_videos_933d5ad5`
- **Source**: **9 videos from Pexels (inferred from filenames)**
- **Action label**: `Dexterous Hand movements`
- **HQ exported frames**: **9112** (includes augmentation duplicates)
...
|---|---:|
| Videos processed | 9 |
| Frames exported (HQ, incl. augmentations) | 9112 |
| Frames sampled (pre-augmentation candidates) | 3962 |
| Frames accepted (pre-augmentation) | 2278 |
| Accepted percentage (pre-aug / sampled) | 57.50% |
| Mean frame quality score (accepted) | 0.9715 |
| Mean avg landmark visibility (accepted) | 0.9430 |
